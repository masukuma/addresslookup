...
import com.nobledesignlabs.lookupaddress.NavigationActivity;
...
public class GetDirectionsAsyncTask extends AsyncTask<Map<String, String>, Object, ArrayList<LatLng>>
{
    ...
    private NavigationBaseActivity activity;
    private Exception exception;
    private ProgressDialog progressDialog;
 
    public GetDirectionsAsyncTask(NavigationBaseActivity activity)
    {
        super();
