...
//		}
	...
	public OAuth2Helper(SharedPreferences sharedPreferences) {
		this(sharedPreferences,CommonStuff.OAUTH2PARAMS);
	}
	...
	public void retrieveAndStoreAccessToken(String authorizationCode) throws IOException {
		Log.i(CommonStuff.TAG,"retrieveAndStoreAccessToken for code " + authorizationCode);
		...
		Log.i(CommonStuff.TAG, "Found tokenResponse :");
		Log.i(CommonStuff.TAG, "Access Token : " + tokenResponse.getAccessToken());
		Log.i(CommonStuff.TAG, "Refresh Token : " + tokenResponse.getRefreshToken());
	...
	public String executeApiCall() throws IOException {
		Log.i(CommonStuff.TAG,"Executing API call at url " + this.oauth2Params.getApiUrl());
