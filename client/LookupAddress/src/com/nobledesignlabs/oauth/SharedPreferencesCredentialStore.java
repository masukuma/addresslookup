...
public class SharedPreferencesCredentialStore implements CredentialStore {
	...
	public boolean load(String userId, Credential credential)
			throws IOException {
		Log.i(CommonStuff.TAG,"Loading credential for userId " + userId);
		Log.i(CommonStuff.TAG,"Loaded access token = "  + prefs.getString(userId + ACCESS_TOKEN, ""));
	...
	public void store(String userId, Credential credential) throws IOException {
		Log.i(CommonStuff.TAG,"Storing credential for userId " + userId);
		Log.i(CommonStuff.TAG,"Access Token = " + credential.getAccessToken());
	...
	public void delete(String userId, Credential credential) throws IOException {
		Log.i(CommonStuff.TAG,"Deleting credential for userId " + userId);
		Editor editor = prefs.edit();
